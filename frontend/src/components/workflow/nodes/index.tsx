...
import {
  Play, Zap, Users, Link2, GitBranch, RefreshCw, FileText, Square,
} from "lucide-react";
...
const handleCls = (color: string) =>
  `!h-3 !w-3 !rounded-full !border-2 ${color} !bg-zinc-950`;

// ── Node types ────────────────────────────────────────────────

export function StartNode({ data, selected, isConnectable }: NodeProps) {
  ...
  return (
    <div className="relative">
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={isConnectable} className={handleCls("!border-emerald-500")} />
    </div>
  );
}

export function AgentNode({ data, selected, isConnectable }: NodeProps) {
  const d = data as Record<string, string>;
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-indigo-500")} />
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={isConnectable} className={handleCls("!border-indigo-500")} />
    </div>
  );
}

export function TeamNode({ data, selected, isConnectable }: NodeProps) {
  const d = data as Record<string, string>;
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-violet-500")} />
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={isConnectable} className={handleCls("!border-violet-500")} />
    </div>
  );
}

export function IntegrationNode({ data, selected, isConnectable }: NodeProps) {
  const d = data as Record<string, string>;
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-amber-500")} />
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={isConnectable} className={handleCls("!border-amber-500")} />
    </div>
  );
}
...
export function DecisionNode({ data, selected, isConnectable }: NodeProps) {
  ...
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-yellow-500")} />
      ...
      {conditions.map((c, i) => (
        <Handle
          ...
          className={handleCls("!border-yellow-500")}
        />
      ))}
    </div>
  );
...
export function LoopNode({ data, selected, isConnectable }: NodeProps) {
  ...
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-cyan-500")} />
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={isConnectable} className={handleCls("!border-cyan-500")} />
    </div>
  );
}

export function NoteNode({ data, selected, isConnectable }: NodeProps) {
  const d = data as Record<string, string>;
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-zinc-500")} />
      ...
      <Handle type="source" position={Position.Bottom} isConnectable={isConnectable} className={handleCls("!border-zinc-500")} />
    </div>
  );
}

export function EndNode({ data, selected, isConnectable }: NodeProps) {
  const d = data as Record<string, string>;
  return (
    <div className="relative">
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className={handleCls("!border-red-500")} />
